...
- Monthly CAC reporting should default to DTC-only: use Finaloop DTC allocated ad spend divided by Shopify Analytics DTC new_customer_orders; Shopify Analytics customer counts must be upserted and preserved across Finaloop KPI rebuilds, excluding Faire/wholesale_faire, company-level spend, and broad sm_expense unless explicitly requested.
